...
<body>
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label>Capacite</label> <input type="number" name="capacite"
									class="form-control" id="capacite" placeholder=""
									value="<%=request.getParameter("capacite") == null ? "" : request.getParameter("capacite")%>">
							</div>
							<div class="form-group">
	...
	<script type="text/javascript" src="script/salles.js"></script>
</body>
</body>
</html>