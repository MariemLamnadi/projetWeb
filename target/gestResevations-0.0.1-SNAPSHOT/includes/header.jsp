                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left mailbox animated bounceInDown">
                                <ul class="list-style-none">
                                    <li>
                                        <div class="message-center notifications position-relative ps-container ps-theme-default" data-ps-id="2b3c3a32-d73c-d6fa-9d6a-096a27a0ee2c">
                                            <!-- Message -->
                    ...
                    <!--    <li class="nav-item d-none d-md-block">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Bonjour,</span> <span class="text-dark"><%= session.getAttribute("login") %></span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down svg-icon"><polyline points="6 9 12 15 18 9"></polyline></svg></span>
                            </a>
